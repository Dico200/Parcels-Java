...
public class ParcelSchematic {
    ...
    public void swapWith(ParcelSchematic other) {
    	parcel.pasteAt(other.parcel.getX0(), other.parcel.getY0(), other.parcel.getZ0(), other.parcel.entitiesInOrigin(), true);
    	other.parcel.pasteAt(parcel.getX0(), parcel.getY0(), parcel.getZ0(), parcel.entitiesInOrigin(), true);
    }
