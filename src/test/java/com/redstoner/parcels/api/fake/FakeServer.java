/*
 * From https://raw.githubusercontent.com/essentials/Essentials/2.x/Essentials/test/com/earth2me/essentials/FakeServer.java
 */

package com.redstoner.parcels.api.fake;
...
public class FakeServer implements Server
{
	...
	protected org.bukkit.OfflinePlayer createOPlayer(final String string)
	{
		return new org.bukkit.OfflinePlayer()
		{
			...
			{
				if (string == "fakePlayer1")
				{
					return ParcelsApiTest.fakeUUID1;
				}
				else if (string == "fakePlayer2")
				{
					return ParcelsApiTest.fakeUUID2;
				}
	...
	{
		if (arg0.equals(ParcelsApiTest.fakeUUID1))
		{
			return createOPlayer("fakePlayer1");
		}
		if (arg0.equals(ParcelsApiTest.fakeUUID2))
		{
			return createOPlayer("fakePlayer2");
		}
		throw new UnsupportedOperationException("Not supported yet.");
	}
